...
//
//        week14_exam2_Proccesing proccesing = new week14_exam2_Proccesing();                                             // 수당 계산
//        for (int i = 0; i < person.length; i++) {
////            money[i][0] = pay_stepProcess(person[i][2]);
//            proccesing.pay_stepProcess(person, money);
//        }
//
//
//
